        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((memory, idx) => (
              <Reveal key={memory.id} delay={idx * 60}>
                <button
                  type="button"
                  onClick={() => openLightbox(idx)}
                  className="group relative rounded-xl overflow-hidden bg-surface border border-border shadow-card hover:shadow-md transition-all text-left focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 w-full h-full"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-slate-950/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        ...
        >
          ...
          >
            <img
              ...
              src={filtered[activeIndex].image || filtered[activeIndex].cover}
